		...
		<div className={cn('relative flex items-center w-full', className)}>
			<form action={formAction} className="relative">
				<input
					type={type}
					className={cn(
						'file:text-foreground placeholder:text-muted-foreground selection:bg-primary selection:text-primary-foreground dark:bg-input/20 border-input flex h-8 w-full min-w-0 rounded-md border bg-transparent px-3 text-base dark:text-white shadow-xs transition-[color,box-shadow] outline-none file:inline-flex file:h-7 file:border-0 file:bg-transparent file:text-sm file:font-medium disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 md:text-sm',
